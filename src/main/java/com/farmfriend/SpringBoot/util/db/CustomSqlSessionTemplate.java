...
import com.farmfriend.common.entry.DataSourceType;
...
public class CustomSqlSessionTemplate extends SqlSessionTemplate {
    Logger logger = LoggerFactory.getLogger(CustomSqlSessionTemplate.class);
    ...
    /**
     * 重写获取SqlSessionFactory方法,获取自定义的SqlSessionFactory
     * @return
     */
    @Override
    public SqlSessionFactory getSqlSessionFactory() {
        DataSourceType dataSourceType = DynamicDataSourceHolder.get();
        logger.info("获取到>>"+dataSourceType);
